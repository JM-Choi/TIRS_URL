...
namespace TechFloor.Vision
{
    ...
    public class FormAbout : System.Windows.Forms.Form
    {
        ...
        private CompositeImageProcessControl mCompositeImageProcessControl;

        public FormAbout(string fname, CompositeImageProcessControl ctl)
        {
            //
            ...
            mCompositeImageProcessControl = ctl;
        }
        ...
        private void FormAbout_Load(object sender, System.EventArgs e)
        {
            ...
            // general info
            this.textBox_AppInfo.Text = ResourceUtility.FormatString("RtAppGeneratedInfo", CompositeImageProcessControl.GenerationDateTime.ToString("r"), CompositeImageProcessControl.GeneratedByVersion);

            // vpp filename
            textBox_VppFilename.Text = mCompositeImageProcessControl.LoadedVppFilename;
            if (textBox_VppFilename.Text == "")
                textBox_VppFilename.Text = ResourceUtility.GetString("RtNoFile");

            // password info
            if (mCompositeImageProcessControl.UsingPasswords)
            {
                if (mCompositeImageProcessControl.CurrentPasswordFile != null &&
                    mCompositeImageProcessControl.CurrentPasswordFile.PasswordFileValid)
                    textBox_PasswordFile.Text = mCompositeImageProcessControl.CurrentPasswordFile.PasswordFilename;
                else
