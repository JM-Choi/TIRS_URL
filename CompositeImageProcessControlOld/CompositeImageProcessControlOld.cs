...
namespace TechFloor.Vision
{
    ...
    public partial class CompositeImageProcessControlOld : UserControl
    {
        #region Private data
        ...
        /// </summary>
        public event CompositeImageProcessControlOldUserResultAvailableEventHandler CompositeImageProcessControlOldUserResultAvailable = null;
        ...
        /// <summary>
        /// This method serves to close the CompositeImageProcessControlOld. 
        ...
        public CompositeImageProcessControlOld()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                if (result != null)
                {
                    ...
                    if (jobIndex >= 0)
                    {
                        ...
                        CompositeImageProcessControlOldUserResultAvailableEventHandler delegateCopy = CompositeImageProcessControlOldUserResultAvailable;
    ...
    public delegate void CompositeImageProcessControlOldUserResultAvailableEventHandler(object sender, CompositeImageProcessControlUserResultAvailableEventArgs e);
    #endregion
}
#endregion