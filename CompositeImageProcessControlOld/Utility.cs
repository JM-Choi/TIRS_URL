...
namespace TechFloor.Vision
{
    ...
    public class Utility
    {
        ...
        private static Type GetPropertyType(object obj, string path)
        {
            ...
            System.Reflection.MemberInfo[] infos = CogToolTerminals.ConvertPathToMemberInfos(obj, obj.GetType(), path);
    ...
    public class ResourceUtility
    {
        ...
        {
            mResources = new ResourceManager("TechFloor.Vision.strings", System.Reflection.Assembly.GetExecutingAssembly());
        }
