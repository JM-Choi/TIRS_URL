...
namespace TechFloor.Vision
{
  ...
  public class FormAbout : System.Windows.Forms.Form
  {
    ...
    private CompositeImageProcessControlOld mVisionControl;

    public FormAbout(string fname, CompositeImageProcessControlOld ctl)
    {
      //
    ...
    private void FormAbout_Load(object sender, System.EventArgs e)
    {
      ...
      // general info
      this.textBox_AppInfo.Text = ResourceUtility.FormatString("RtAppGeneratedInfo", CompositeImageProcessControlOld.GenerationDateTime.ToString("r"),
        CompositeImageProcessControlOld.GeneratedByVersion);
