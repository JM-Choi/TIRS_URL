...
namespace Marcus.Solution.TechFloor
{
    public class ReelPackageObject
    {
        ...
        public void SetStateWithRoute(TransferStates val, ReelTypes reeltype, int tower)
        {
            switch (state = val)
            {
                case TransferStates.ConfirmedBarcodeOfCart:
        ...
        public void SetStateWithRoute(TransferStates val, ReelTypes reeltype, int workslot, int tower)
        {
            switch (state = val)
            {
                case TransferStates.ConfirmedBarcodeOfCart:
